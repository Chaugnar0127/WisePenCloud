...
public class KafkaEventPublisherImpl implements IEventPublisher {
    ...
    public void publishResourceForkEvent(ResourceForkMessage message) {
        ...
        log.info("resourceFork published topic={} sourceResourceId={} newResourceId={} resourceType={}",
                MqTopicConstants.TOPIC_RESOURCE_FORK,
                message.getSourceResourceId(), newResourceId, message.getResourceType());
        reliablePublisher.publish(MqTopicConstants.TOPIC_RESOURCE_FORK, newResourceId, message, newResourceId);
    }
}